...
const zhTranslations = {
  ...
  hero: {
    title1: '你的面容',
    title1Part2: '完美理解',
    title2: '在改变之前，先充分理解你的面部',
    title2Mobile: '在改变之前，先充分理解你的面部',
    title3Mobile: '',
    title4Mobile: '',
    cta: '现在开始探索',
  },
  ...
  concerns: {
    title: '很多人不是不好看，\n只是一直在错误地改善自己。',
    subtitle: '真正的变美，是先理解面部关系，再决定改善与保留。',
    issue1Title: '没有先分析面部结构，就直接做项目',
    issue1Desc: '很多人一上来就问适合填哪里、削哪里、打哪里，但真正的问题可能是骨相、软组织、比例、轮廓转折或动态表情失衡。',
    issue2Title: '照着模板变美，结果丢掉自己的辨识度',
    issue2Desc: '同一种鼻子、同一种下巴、同一种饱满苹果肌，并不适合每一张脸。模板化改善会让五官看似精致，却和原本气质不匹配。',
    issue3Title: '过度填充导致面部膨胀、钝化、漫化',
    issue3Desc: '很多脸不是不够饱满，而是比例、支撑点或轮廓线出了问题。盲目填充会让面部变宽、变肿、边界变模糊。',
    issue4Title: '只改单个部位，忽略整体比例关系',
    issue4Desc: '鼻子、下巴、颧骨、额头、嘴唇、下颌线是互相影响的。单个部位变好看，不代表整张脸会更协调。',
    issue5Title: '没有考虑人种骨架、皮肤厚度和动态表情',
    issue5Desc: '不同人种、不同骨相、不同软组织厚度，适合的改善方式完全不同。只看静态照片，不看真实面部条件，方案就容易失真。',
    issue6Title: '医生选择不对，方案再贵也可能走偏',
    issue6Desc: '好的医生不会一味建议多做一点，而是能判断哪些地方该改善、哪些地方该保留、哪些项目根本不适合你。',
  },
  philosophy: {
    eyebrow: 'YANORA METHOD',
    title: 'Yanora 不卖项目，\n而是先建立你的面部优先级。',
    subtitle: '我们把每一张脸放回整体关系里判断：先看结构是否支撑，再看比例是否平衡，最后保留真正属于你的个性。',
    priorityLabel: 'FACE PRIORITY',
    priorityTitle: '先判断顺序，再决定项目。',
    structureTitle: '结构',
    structureDesc: '判断骨相支撑、轮廓转折、软组织厚度和面部承重点，先找到真正影响脸型的底层原因。',
    balanceTitle: '平衡',
    balanceDesc: '分析五官、轮廓、明暗面与动态表情之间的关系，避免单点改善破坏整体协调。',
    identityTitle: '个性',
    identityDesc: '保留你的辨识度、气质和人种特征，让改善服务于你自己，而不是把你变成模板。',
  },
  comparison: {
    title: '不同的理念，\n会得到完全不同的结果。',
    traditionalLabel: 'TRADITIONAL CLINICS',
    yanoraLabel: 'YANORA',
    traditionalItems: [
      { title: '快速推荐项目', subtitle: 'Quick upsell' },
      { title: '模板化审美标准', subtitle: 'Cookie-cutter aesthetics' },
      { title: '过度填充注射', subtitle: 'Over-injection' },
      { title: '一次性成交逻辑', subtitle: 'Transactional' },
      { title: '流水线方案执行', subtitle: 'Assembly-line care' },
    ],
    yanoraItems: [
      { title: '先分析再改善', subtitle: 'Analyse, then act' },
      { title: '保留个人气质', subtitle: "Preserve what's yours" },
      { title: '自然结构平衡', subtitle: 'Natural equilibrium' },
      { title: '长期恢复逻辑', subtitle: 'Long-term thinking' },
      { title: '个性化美学判断', subtitle: 'Bespoke aesthetic logic' },
    ],
  },
  numbers: {
    ...
    watermark: 'TRUST',
    items: [
      { value: '20k+', label: 'FACIAL ANALYSES', sublabel: '面部分析案例' },
      { value: '50+', label: 'PARTNER DOCTORS', sublabel: '合作医生' },
      { value: '12', label: 'COUNTRIES', sublabel: '全球客户来源国' },
      { value: '98%', label: 'SATISFACTION RATE', sublabel: '客户满意度' },
    ],
  },
  facialAnalysis: {
    foreheadTitle: '额面分析',
  ...
  bodySculpting: {
    ...
    details: {
      waist: {
        title: '折角腰塑形',
        desc: '通过肋骨内推的方式 让腰部呈现一个折角的弧度',
        techniques: ['肋骨内推 打造S曲线', '后腰凹陷塑造', '侧腰线条雕刻', '腰臀比例黄金设计'],
      },
      breast: {
        title: '隆胸手术',
  ...
  hairTransplant: {
    ...
    services: {
      ...
      fueShort: { title: 'FUE短发植发', desc: '适合短发人群' },
      fueLong: { title: 'FUE长发植发', desc: '适合长发人群' },
    },
    details: {
      fueShort: {
        title: 'FUE短发植发',
        desc: '采用先进的毛囊单位提取技术，适合短发人群，逐个提取健康毛囊进行种植，无需开刀，不留疤痕，恢复快，效果自然。',
        features: ['适合大面积脱发', '毛囊存活率高达95%以上', '术后3-5天即可正常工作', '无痕迹自然美观'],
      },
      fueLong: {
        title: 'FUE长发植发',
        desc: '专为长发人群设计的FUE技术，在不剃发的情况下进行毛囊提取和种植，保持原有发型，术后即刻见效，适合注重隐私的客户。',
        features: ['无需剃发，保持发型', '隐私性强，术后不易察觉', '即刻见效', '适合商务人士'],
      },
    },
    caseImageAlt: (service: string, index: number) => `${service} 案例 ${index + 1}`,
  },
  ...
  paymentPage: {
    ...
    paypal: 'PayPal',
    bankCard: '银行卡 (Stripe)',
    paypalDev: 'PayPal 支付功能开发中，敬请期待',
    bankCardDev: '银行卡支付功能开发中，敬请期待',
    confirmServices: '确认选择的服务',
    backToBooking: '返回预约',
    lifetimeVip: '终身VIP服务',
    injectionConsult: '注射调整建议',
    surgeryConsult: '手术建议',
    facialAnalysis: '面部基础分析',
  },
  bookingSuccess: {
    title: '预约成功！',
    subtitle: '感谢您选择 YANORA，我们已收到您的预约和付款',
    loading: '加载中...',
    detailsTitle: '预约详情',
    bookingNumber: '预约编号',
    contactEmail: '联系邮箱',
...
const enTranslations = {
  ...
  hero: {
    ...
    title2: 'Understand your face fully before making any change',
    title2Mobile: 'Understand your face fully before making any change',
    title3Mobile: '',
    title4Mobile: '',
  ...
  concerns: {
    title: 'Many people are not unattractive.\nThey have just been improving themselves in the wrong direction.',
    subtitle: 'Real refinement starts by understanding facial relationships, then deciding what to improve and preserve.',
    issue1Title: 'Starting treatments before analyzing facial structure',
    issue1Desc: 'The real issue may be bone support, soft tissue, proportion, contour transitions, or dynamic expression. Without diagnosis, every treatment can push the face further off balance.',
    issue2Title: 'Following a beauty template and losing recognizability',
    issue2Desc: 'The same nose, chin, or full apple cheek does not suit every face. Template-based changes may look refined in isolation but disconnected from your original character.',
    issue3Title: 'Overfilling that makes the face swollen and blurred',
    issue3Desc: 'Many faces do not need more volume. They need better proportion, support, or contour clarity. Blind filling can make the face wider, heavier, and less defined.',
    issue4Title: 'Changing one feature while ignoring the whole face',
    issue4Desc: 'The nose, chin, cheekbones, forehead, lips, and jawline affect one another. Making one feature attractive does not guarantee the whole face becomes harmonious.',
    issue5Title: 'Ignoring ethnicity, skin thickness, and expression',
    issue5Desc: 'Different skeletal patterns and soft tissue conditions require different strategies. A plan based only on still photos can easily miss the real facial condition.',
    issue6Title: 'Choosing the wrong doctor can misdirect any plan',
    issue6Desc: 'A good doctor does not simply suggest doing more. They know what should be improved, what should be preserved, and which procedures are not suitable for you.',
  },
  philosophy: {
    eyebrow: 'YANORA METHOD',
    title: 'Yanora does not sell procedures.\nWe build your facial priorities first.',
    subtitle: 'Every face is evaluated as a whole: structure comes first, balance comes next, and identity is protected throughout the plan.',
    priorityLabel: 'FACE PRIORITY',
    priorityTitle: 'Define the order first. Decide the procedure second.',
    structureTitle: 'Structure',
    structureDesc: 'We assess skeletal support, contour transitions, soft tissue thickness, and load-bearing areas to find the real cause beneath the face shape.',
    balanceTitle: 'Balance',
    balanceDesc: 'We study how features, contours, light and shadow, and facial movement relate to one another, so one improvement does not disrupt the whole face.',
    identityTitle: 'Identity',
    identityDesc: 'We preserve your recognizability, temperament, and ethnic features, so refinement serves you instead of turning you into a template.',
  },
  comparison: {
    ...
    yanoraLabel: 'YANORA',
    traditionalItems: [
      { title: 'Quick procedure recommendation', subtitle: 'Quick upsell' },
      { title: 'Template-based beauty standard', subtitle: 'Cookie-cutter aesthetics' },
      { title: 'Excessive filler and injection', subtitle: 'Over-injection' },
      { title: 'One-time transaction logic', subtitle: 'Transactional' },
      { title: 'Assembly-line plan execution', subtitle: 'Assembly-line care' },
    ],
    yanoraItems: [
      { title: 'Analyse before improving', subtitle: 'Analyse, then act' },
      { title: 'Preserve personal temperament', subtitle: "Preserve what's yours" },
      { title: 'Balance natural structure', subtitle: 'Natural equilibrium' },
      { title: 'Think in long-term recovery', subtitle: 'Long-term thinking' },
      { title: 'Make bespoke aesthetic judgments', subtitle: 'Bespoke aesthetic logic' },
    ],
  },
  numbers: {
    eyebrow: 'NUMBERS THAT MATTER',
    watermark: 'TRUST',
    items: [
      { value: '20k+', label: 'FACIAL ANALYSES', sublabel: 'Facial analysis cases' },
      { value: '50+', label: 'PARTNER DOCTORS', sublabel: 'Partner doctors' },
      { value: '12', label: 'COUNTRIES', sublabel: 'Client source countries' },
      { value: '98%', label: 'SATISFACTION RATE', sublabel: 'Client satisfaction' },
    ],
  },
  facialAnalysis: {
  ...
  bodySculpting: {
    ...
    services: {
      ...
      waist: { title: 'Angled Waist', desc: 'Perfect waistline' },
    ...
    details: {
      waist: {
        title: 'Angled Waist Sculpting',
        desc: 'Create an angled waist curve through rib reduction technique',
        techniques: ['Rib reduction for S-curve', 'Lower back curve creation', 'Side waist line sculpting', 'Golden waist-to-hip ratio design'],
      },
      breast: {
  ...
  hairTransplant: {
    ...
    services: {
      ...
      fueShort: { title: 'FUE Short Hair Transplant', desc: 'Suitable for short hair' },
      fueLong: { title: 'FUE Long Hair Transplant', desc: 'Suitable for long hair' },
    },
    details: {
      fueShort: {
        title: 'FUE Short Hair Transplant',
        desc: 'Using advanced follicular unit extraction technology, suitable for short hair individuals, extracting and planting healthy follicles one by one, no surgery required, no scarring, fast recovery, natural results.',
      ...
      fueLong: {
        title: 'FUE Long Hair Transplant',
        desc: 'FUE technique designed specifically for long hair individuals, extracting and planting follicles without shaving, maintaining original hairstyle, immediate results, suitable for privacy-conscious clients.',
        features: ['No shaving required, maintain hairstyle', 'High privacy, unnoticeable after surgery', 'Immediate results', 'Suitable for business professionals'],
      },
    },
    caseImageAlt: (service: string, index: number) => `${service} Case ${index + 1}`,
  },
  ...
  paymentPage: {
    ...
    paypalDev: 'PayPal payment feature is under development',
    bankCardDev: 'Bank card payment feature is under development',
    confirmServices: 'Confirm Selected Services',
    backToBooking: 'Back to Booking',
    lifetimeVip: 'Lifetime VIP Service',
    injectionConsult: 'Injection Adjustment Consultation',
    surgeryConsult: 'Surgical Consultation',
    facialAnalysis: 'Basic Facial Analysis',
  },
  bookingSuccess: {
    title: 'Booking Successful!',
    subtitle: 'Thank you for choosing YANORA, we have received your booking and payment',
    loading: 'Loading...',
    ...
    nextSteps: [
      'We have sent a confirmation email to your inbox, please check',
      'Our team will contact you within 24 hours to confirm the specific time',
